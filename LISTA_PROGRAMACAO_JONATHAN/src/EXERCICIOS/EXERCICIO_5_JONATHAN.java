...
public class EXERCICIO_5_JONATHAN {
	...
	public static void main(String[] args) {
		...
		double medGeral = primeiro+segundo+terceiro;
		String status;
		if(medGeral>=60) {
			status="aprovado";
		}else {
		...
		System.out.printf("\nA média geral desse aluno foi de "+ medGeral+"/100"+", portanto esse aluno foi " + status+"!");
